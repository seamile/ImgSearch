...
ImgSearch supports multiple TinyCLIP model, balancing speed, accuracy, and resources. The default `ViT-45LY` is suitable for most scenarios.
...
ImgSearch 支持多种 TinyCLIP 模型，平衡速度、准确率和资源。默认 `ViT-45LY` 适用于大多数场景。
